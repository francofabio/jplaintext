 ...
 * 
 * Proposed by Fábio Franco in the project vraptor-jackson-plugin
 * 
 */
public class NamedTreeNode {
	...
	public <T> T getDataAs(String key, Class<T> cls) {
		return cls.cast(getData(key));
	}
	...
	public String getPath() {
		...
		while (node.getParent() != null) {
			node = node.getParent();
			if (node.getName() != null && !node.getName().trim().equals("")) {
